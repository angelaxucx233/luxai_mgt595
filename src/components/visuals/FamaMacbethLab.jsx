  ...
  return (
    <div className="w-full max-w-xl flex flex-col items-center gap-2">
      <svg viewBox="0 0 420 178" className="w-full">
        {/* scatter: this month */}
        <text x="100" y="11" textAnchor="middle" fontSize="9.5" fill="#93b8e8" fontWeight="700">Month {m} cross-section</text>
        <line x1="16" y1="150" x2="196" y2="150" stroke="#94a3b8" /><line x1="16" y1="150" x2="16" y2="18" stroke="#94a3b8" />
        <text x="192" y="162" textAnchor="end" fontSize="8.5" fill="#a3b1c2">β̂ᵢ</text>
        ...
        <text x="100" y="174" textAnchor="middle" fontSize="9" fill="#fb7185" fontWeight="700">γ̂₂,{m} = {cur.slope.toFixed(2)} %/mo</text>
        {/* histogram of slopes so far */}
        <text x="315" y="11" textAnchor="middle" fontSize="9.5" fill="#93b8e8" fontWeight="700">Slopes so far ({m} months)</text>
        <line x1="232" y1="150" x2="405" y2="150" stroke="#94a3b8" />
        {bins.map((c, k) => (
          <rect key={k} x={232 + k * 14.2} y={150 - (c / maxBin) * 118} width="12.5" height={(c / maxBin) * 118} fill="#3b82f6" opacity="0.85" rx="1.5" />
        ))}
        <line x1={232 + ((mean + 3) / 10) * 170} y1="150" x2={232 + ((mean + 3) / 10) * 170} y2="26" stroke="#d97706" strokeWidth="2" strokeDasharray="4 3" />
        <text x="318" y="166" textAnchor="middle" fontSize="8.5" fill="#a3b1c2">−3 … γ̂₂,t … +7</text>
      </svg>
  ...
  return (
    <div className="w-full max-w-lg flex flex-col items-center gap-2">
      ...
      <svg viewBox="0 0 400 158" className="w-full">
        ...
        <text x="386" y="152" textAnchor="end" fontSize="9" fill="#a3b1c2">β̂ (noisy)</text>
        ...
        <text x={X(2.02)} y={Y(0.3 + TRUE_PREM * 2.1) - 6} fontSize="8.5" fill="#cbd5e1">true (0.60)</text>
        ...
        <text x={X(2.24)} y={Y(1.02 + fitted * 1) + 3} fontSize="9" fill="#fb7185" fontWeight="700">{fitted.toFixed(2)}</text>
      </svg>
