      ...
      {tab === 'split' && (
        <>
          <svg viewBox="0 0 400 150" className="w-full">
            <rect x="120" y="10" width="160" height="32" rx="7" fill="#3b82f6" />
            ...
            <text x="200" y="128" textAnchor="middle" fontSize="9" fill="#e2e8f0" fontWeight="700">Leverage L = (Total Assets − Cash) / Equity ≈ 1.6-to-1</text>
            <text x="200" y="143" textAnchor="middle" fontSize="8.5" fill="#a3b1c2">— financed largely by insurance float: cheap, stable, and never subject to a margin call</text>
          </svg>
      ...
      {tab === 'reg' && (
        <>
          <svg viewBox="0 0 400 158" className="w-full">
            <text x="14" y="12" fontSize="8.5" fill="#a3b1c2">annualized alpha of Berkshire</text>
            <line x1="26" y1="126" x2="230" y2="126" stroke="#94a3b8" />
            <g>
              <rect x="46" y={126 - 12.1 * 8} width="64" height={12.1 * 8} fill="#3b82f6" rx="4" />
              <text x="78" y={126 - 12.1 * 8 - 6} textAnchor="middle" fontSize="10.5" fill="#93b8e8" fontWeight="800">12.1%</text>
              <text x="78" y="140" textAnchor="middle" fontSize="8" fill="#a3b1c2">4-factor</text>
              <text x="78" y="151" textAnchor="middle" fontSize="7.5" fill="#cbd5e1">t = 3.19</text>
            </g>
            <g>
              <rect x="140" y={126 - 6.3 * 8} width="64" height={6.3 * 8} fill="#94a3b8" rx="4" />
              <text x="172" y={126 - 6.3 * 8 - 6} textAnchor="middle" fontSize="10.5" fill="#a3b1c2" fontWeight="800">6.3%</text>
              <text x="172" y="140" textAnchor="middle" fontSize="8" fill="#a3b1c2">+ BAB + QMJ</text>
              <text x="172" y="151" textAnchor="middle" fontSize="7.5" fill="#fb7185" fontWeight="700">t = 1.58 — n.s.</text>
            </g>
            <g>
              ...
              {[
                ...
                ['UMD', '≈ 0', '#94a3b8'], ['BAB', '0.29 (t 2.67)', '#3b82f6'], ['QMJ', '0.43 (t 2.34)', '#3b82f6'],
              ].map(([k, v, c], i) => (
                <g key={k}>
                  <text x="264" y={52 + i * 15} fontSize="8.5" fill="#94a3b8" fontWeight="700">{k}</text>
      ...
      {tab === 'sys' && (
        <>
          <svg viewBox="0 0 400 122" className="w-full">
            <text x="14" y="12" fontSize="8.5" fill="#a3b1c2">cumulative return, log scale (stylized shape of the paper’s figure)</text>
            <path d="M 24 104 C 90 92, 150 74, 210 56 C 270 38, 330 26, 390 14" fill="none" stroke="#3b82f6" strokeWidth="2.4" />
            ...
            <text x="300" y="14" fontSize="8.5" fill="#93b8e8" fontWeight="700">Berkshire public book</text>
            <text x="252" y="40" fontSize="8.5" fill="#d97706" fontWeight="700">systematic Buffett-style</text>
            <text x="320" y="66" fontSize="8.5" fill="#cbd5e1">market, same vol</text>
          </svg>
          <div className="w-full rounded-xl bg-yale-50 border border-yale-100 px-3 py-2 text-[11px] text-yale-900">
