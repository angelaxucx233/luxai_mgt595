  ...
  return (
    <div className="w-full max-w-lg flex flex-col items-center gap-3">
      ...
      <svg viewBox="0 0 420 218" className="w-full">
        ...
        <text x="400" y="213" textAnchor="end" fontSize="10" fill="#64748b">β</text>
        <text x="42" y="12" textAnchor="end" fontSize="10" fill="#64748b">E[r] (%)</text>
        {/* SML */}
        <line x1={X(0)} y1={Y(rf)} x2={X(2.2)} y2={Y(rf + 2.2 * prem)} stroke="#00356b" strokeWidth="2.5" />
        <text x={X(1.9)} y={Y(rf + 1.9 * prem) - 8} fontSize="11" fill="#00356b" fontWeight="700">SML</text>
        {/* rf and market */}
        <circle cx={X(0)} cy={Y(rf)} r="5" fill="#d97706" />
        <text x={X(0) + 7} y={Y(rf) + 13} fontSize="10" fill="#b45309" fontWeight="600">r_f = 3%</text>
        <circle cx={X(1)} cy={Y(mkt)} r="5" fill="#d97706" stroke="#00356b" strokeWidth="1" />
        <text x={X(1) + 8} y={Y(mkt) + 12} fontSize="10" fill="#b45309" fontWeight="600">market (β=1)</text>
        {/* asset */}
