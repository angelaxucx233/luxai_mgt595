...
export const lecture06Slides = [
  ...
  // ── Block B: BAB ──
  {
    ...
    content: {
      ...
      footnote: 'Drag $\\psi$ and watch the SML pivot around $\\beta = 1$.',
    },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      slideId: 7,
      scenario: 'Funding-liquidity CAPM: $E[r] = rf + \\psi + \\beta \\cdot \\lambda$, with $\\lambda = E[rM] - rf - \\psi$. Take $rf = 2\\%$, $\\psi = 1.5\\%$, and $E[rM] - rf = 6\\%$. Consider a low-beta stock with $\\beta = 0.5$.',
      question: 'Find the risk premium λ, and the stock\'s alpha relative to the standard CAPM.',
      given: [['rf', '2%'], ['ψ', '1.5%'], ['E[rM] − rf', '6%'], ['β', '0.5']],
      answers: [
        { label: 'Risk premium $\\lambda$ (%)', value: 4.5, tolerance: 0.05 },
        { label: 'CAPM-alpha (%)', value: 0.75, tolerance: 0.05 },
      ],
      steps: [
        '$\\lambda = (E[rM] - rf) - \\psi = 6 - 1.5 = 4.5\\%$.',
        'Funding-CAPM: $E[r] = 2 + 1.5 + 0.5\\times 4.5 = 5.75\\%$. Standard CAPM: ${}2 + 0.5\\times 6 = 5.0\\%$.',
        'Alpha = 5.75 − 5.0 = +0.75% — exactly $\\psi (1-\\beta ) = 1.5\\times 0.5$.',
        '$\\text{Run} \\beta = 1.5$ and the sign flips: alpha = −0.75%. High beta is low alpha; the whole BAB trade is this formula.',
      ],
    },
    ...
    content: { eyebrow: 'Your turn', heading: 'Price a Stock When Leverage Is Scarce', problemTitle: 'Your Turn: Price a Stock When Leverage Is Scarce', footnote: '$\\alpha = \\psi(1-\\beta)$: the entire BAB paper in five symbols.' },
  },
  ...
  },
  {
    ...
    visualProps: {
      ...
      steps: [
        'X: $P/B = (0.30\\times 0.5)/(0.10-0.05) = 0.15/0.05 = 3.0$.',
    ...
    content: { eyebrow: 'Your turn', heading: 'The Gordon Price of Quality', problemTitle: 'Your Turn: The Gordon Price of Quality', footnote: '$P/B = \\text{prof}\\cdot\\text{payout}/(r-g)$, and its inverse.' },
  },
  ...
  },
  {
    ...
    visualProps: {
      ...
      given: [['$\\alpha$ (4-factor)', '12.1%'], ['$\\alpha$ $(+\\text{BAB}, +\\text{QMJ})$', '6.3%']],
      answers: [
