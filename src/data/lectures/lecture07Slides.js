...
export const lecture07Slides = [
  ...
  },
  {
    ...
    content: { eyebrow: 'Your turn', heading: 'Put an Error Bar on a Sharpe', problemTitle: 'Your Turn: Put an Error Bar on a Sharpe', footnote: 'SE = √[(1+SR²/2)/(T−1)].' },
  },
  ...
  },
  {
    ...
    visualProps: {
      slideId: 6,
      scenario: 'A desk tested N = 100 signals this year and wants a 5% family-wise error rate using Bonferroni. (Useful: Φ⁻¹(1 − 0.00025) = 3.48.)',
      question: 'What per-test p-value threshold should each signal face, and what t-statistic does that require?',
      given: [['Family α', '5%'], ['N', '100'], ['Hint', 'Φ⁻¹(1−0.00025) = 3.48']],
      answers: [
        { label: 'Per-test p-value (%)', value: 0.05, tolerance: 0.005 },
        { label: 'Required t-stat', value: 3.48, tolerance: 0.03 },
      ],
      steps: [
        'Per-test p = α/N = 0.05/100 = 0.0005 = 0.05%.',
        'Two-sided: each tail gets 0.0005/2 = 0.00025, so t = Φ⁻¹(1−0.00025) = 3.48.',
    ...
    content: { eyebrow: 'Your turn', heading: 'Set the Honest Hurdle', problemTitle: 'Your Turn: Set the Honest Hurdle', footnote: 'p = α/N · t = Φ⁻¹(1−p/2).' },
  },
  ...
  // ── Block D: shrinkage, tradability, theory ──
  {
    ...
    visualProps: {
      ...
      question: 'Compute the shrinkage factor κ and the posterior alpha.',
      given: [['σ', '2%/mo'], ['τ', '0.4%'], ['T', '100'], ['α̂', '0.5%/mo']],
      answers: [
        { label: 'Shrinkage factor κ', value: 0.80, tolerance: 0.01 },
        { label: 'Posterior alpha (%/mo)', value: 0.40, tolerance: 0.01 },
      ],
      steps: [
        'σ²/(τ²T) = 2²/(0.4²×100) = 4/16 = 0.25.',
        'κ = 1/(1+0.25) = 0.80.',
        'Posterior = 0.80 × 0.5 = 0.40%/month.',
        'Interpretation: the prior is worth σ²/τ² = 25 months of zero alpha stacked onto your 100 observed months. A Bayesian always forecasts less than the backtest — which is why out-of-sample "decay" of about this size is the expected outcome, not a crisis.',
      ],
    },
    ...
    content: { eyebrow: 'Your turn', heading: 'Shrink an Alpha', problemTitle: 'Your Turn: Shrink an Alpha', footnote: 'κ = 1/(1+σ²/(τ²T)) — the prior is worth σ²/τ² months of zeros.' },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      ...
      question: 'Compute the mean of the five constructions, and the range (max − min).',
      ...
      steps: [
        'Sum = 3.6 + 5.3 + 4.5 + 1.8 + 2.5 = 17.7. Mean = 17.7/5 = 3.54%.',
