...
export const lecture08Slides = [
  ...
  },
  {
    ...
    visualProps: {
      slideId: 3,
      scenario: 'Value and momentum each have Sharpe ratio 0.4 (mean 0.4, volatility 1.0, in convenient units) and correlation $\\rho = -0.6$. You form a 50/50 combination.',
      question: 'Compute the combo\'s volatility and its Sharpe ratio.',
      given: [['Each SR', '0.4'], ['Each $\\sigma$', '1.0'], ['$\\rho$', '−0.6'], ['Weights', '50/50']],
      answers: [
      ...
      steps: [
        ...
        'Variance: ${}0.25(1) + 0.25(1) + 2(0.25)(-0.6) = 0.5 - 0.3 = 0.2$. $\\text{Volatility} = \\sqrt{0.2} = 0.447$.',
        '$\\text{Sharpe} = 0.4 / 0.447 = 0.894$.',
    ...
    content: { eyebrow: 'Your turn', heading: 'Price the Free Lunch', problemTitle: 'Your Turn: Price the Free Lunch', footnote: '$\\sigma_p^2 = w_1^2\\sigma_1^2 + w_2^2\\sigma_2^2 + 2w_1 w_2\\rho\\sigma_1\\sigma_2$.' },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      ...
      given: [['Sizing rule', '40% / $\\sigma$'], ['Commodity $\\sigma$', '30%'], ['Bond $\\sigma$', '6%']],
      answers: [
        { label: 'Commodity position (×)', value: 1.33, tolerance: 0.02 },
        { label: 'Bond position (×)', value: 6.67, tolerance: 0.05 },
      ],
      steps: [
        'Commodity: ${}0.40 / 0.30 = 1.33\\times \\text{notional}$.',
    ...
    content: { eyebrow: 'Your turn', heading: 'Give Every Market a Vote', problemTitle: 'Your Turn: Give Every Market a Vote', footnote: 'Position $= 40\\%/\\sigma$ — equal ex-ante risk per market.' },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      ...
      steps: [
        'Break-even: $p \\times 210 = 110 \\Rightarrow p = 110/210 = 52.38\\%$.',
        'At 55%: $E[\\text{payoff}] = 0.55 \\times 210 = \\${}115.50 \\Rightarrow \\text{profit} \\${}5.50 \\text{on} \\${}110 = 5.0\\% \\text{of} \\text{stake}$.',
  ...
  },
  {
    ...
    content: {
      ...
      footnote: 'H3: $\\beta_T = -\\beta_1$. The refund is the diagnosis.',
    },
  },
  {
