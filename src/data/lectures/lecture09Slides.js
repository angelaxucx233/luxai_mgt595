...
export const lecture09Slides = [
  // ── Block A: what carry is ──
  {
    ...
    content: {
      ...
      footnote: '$\\text{return} = \\text{carry} + E(\\Delta\\text{price}) + \\text{surprise}$. Only the first term is observable.',
    },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      slideId: 3,
      scenario: 'A commodity trades at spot $S = 100$ with a one-month futures price $F = 98$. Separately, a 10-year bond yields 4.0%, cash is 2.0%, modified duration is 7, and the 9-year yield sits 0.10% below the 10-year $(y_{9} - y_{10} = -0.10\\%)$.',
      question: 'Compute the futures carry and the bond\'s annual carry (slope + roll-down).',
      given: [['S', '100'], ['F', '98'], ['$y_{10}$', '4.0%'], ['r_f', '2.0%'], ['D_mod', '7'], ['$y_{9}$ − $y_{10}$', '−0.10%']],
      answers: [
      ...
      steps: [
        ...
        'Bond slope: $y_{10} - r_f = 4.0 - 2.0 = 2.0\\%$.',
        'Roll-down: $-D\\times (y_{9} - y_{10}) = -7 \\times (-0.10\\%) = +0.70\\%$ — a year from now your bond is a 9-year priced at a lower yield.',
    ...
    content: { eyebrow: 'Your turn', heading: 'Read Two Carries Off the Screen', problemTitle: 'Your Turn: Read Two Carries Off the Screen', footnote: '$C = (S-F)/F$ · bond carry $= \\text{slope} - D\\cdot\\Delta y$.' },
  },
  ...
  },
  {
    ...
    visualProps: {
      ...
      steps: [
        ...
        'A 2% appreciation of the funding currency costs exactly 2 points: $\\text{net} = 6.22 - 2.00 = 4.22\\%$.',
    ...
    content: { eyebrow: 'Your turn', heading: 'The Trade and Its Hostage', problemTitle: 'Your Turn: The Trade and Its Hostage', footnote: 'Net $= (i^* - i) - \\Delta s$. The $\\Delta s$ has fat tails.' },
  },
  {
  ...
  },
  {
    ...
    content: { eyebrow: 'Your turn', heading: 'Grade the Global Factor', problemTitle: 'Your Turn: Grade the Global Factor', footnote: '$\\mathrm{SR} = \\text{mean}/\\text{vol}$ · gap $=$ carry SR $-$ EW SR.' },
  },
  {
  ...
  },
  {
    ...
    visualProps: {
      ...
      steps: [
        'Currencies: ${}10.06 - (-6.81) = 16.87 \\text{points}$.',
        'Commodities: ${}21.49 - (-13.23) = 34.72 \\text{points}$.',
